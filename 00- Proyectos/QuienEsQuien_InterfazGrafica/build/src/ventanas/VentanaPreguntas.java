...
public class VentanaPreguntas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        labelCharizard = new javax.swing.JLabel();
        ...
        labelCharizard.setBackground(new java.awt.Color(255, 255, 255));
        labelCharizard.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/CharizardPreguntas.jpg"))); // NOI18N
        labelCharizard.setText("jLabel1");
        jPanel1.add(labelCharizard, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 570, 580));
    ...
    private void btnTipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTipoActionPerformed
            ...
            //Charizard de que tipo es?
        
        String pokemon = "Charizard";
        String respuesta = JOptionPane.showInputDialog(null, "¿De qué tipo es el Pokemon seleccionado?", "Pregunta", JOptionPane.QUESTION_MESSAGE);
            if (respuesta != null && respuesta.equalsIgnoreCase("fuego")) {
                JOptionPane.showMessageDialog(null, "¡Has acertado! El Pokemon es de tipo fuego.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                JOptionPane.showMessageDialog(null, "Te quedan dos pokemons en la lista con estas caracteristicas", "Aviso", JOptionPane.WARNING_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "Lo siento, has fallado. El Pokemon no es de tipo fuego.", "Respuesta", JOptionPane.ERROR_MESSAGE);
                JOptionPane.showMessageDialog(null, "Te quedan aun los 9 pokemons de la lista", "Aviso", JOptionPane.WARNING_MESSAGE);
            }
        btnTipo.setEnabled(false);
        JOptionPane.showMessageDialog(null, "¡Te quedan 6 preguntas para adivinar el pokemon.", "Numero de preguntas restantes", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void btnAdivinarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdivinarActionPerformed
        //boton de adivinar
        String respuesta = JOptionPane.showInputDialog(null, "¿Cuál es la respuesta?", "¿Quieres intentar adivinar el pokemon?", JOptionPane.QUESTION_MESSAGE);
            if (respuesta != null && respuesta.equalsIgnoreCase("Charizard")) {
                ...
                JOptionPane.showMessageDialog(null, "Lo siento, has fallado. Sigue intentando.", "Resultado", JOptionPane.ERROR_MESSAGE);
            }
    }//GEN-LAST:event_btnAdivinarActionPerformed

    private void btnColorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColorActionPerformed
        String color = "Naranja";
        String respuesta = JOptionPane.showInputDialog(null, "¿De qué color es el Pokemon seleccionado?", "Pregunta", JOptionPane.QUESTION_MESSAGE);
            if (respuesta != null && respuesta.equalsIgnoreCase("Naranja")) {
                JOptionPane.showMessageDialog(null, "¡Has acertado! El Pokemon es de tipo fuego.", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
                JOptionPane.showMessageDialog(null, "Te quedan dos pokemons en la lista con estas caracteristicas", "Aviso", JOptionPane.WARNING_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(null, "Lo siento, has fallado. El Pokemon no es de color naranja.", "Respuesta", JOptionPane.ERROR_MESSAGE);
                JOptionPane.showMessageDialog(null, "Te quedan aun los 9 pokemons de la lista", "Aviso", JOptionPane.WARNING_MESSAGE);
            }
        btnTipo.setEnabled(false);
        JOptionPane.showMessageDialog(null, "¡Te quedan 5 preguntas para adivinar el pokemon.", "Numero de preguntas restantes", JOptionPane.INFORMATION_MESSAGE);
    ...
    private javax.swing.JLabel labelCharizard;
